...
assert.ok(index.includes('Turn the EGX close into a ranked market view.'));
assert.ok(index.includes('class="investor-signal-card"'));
assert.ok(index.includes('Request full ranked access'));
assert.ok(index.includes('Unlock the broader ranked view'));
