...
export function renderSignalPage(payload, canonicalPath = '/today/', recentItems = [], previousPayload = null) {
  ...
  return htmlShell({ title: `EGX /Alpha — ${payload.trading_date} — ${titleSuffix}`, description: `EGX /Alpha quantitative market ranking for the Egyptian Exchange, analysis date ${payload.trading_date}.`, canonicalPath, payload, pageClass: 'page-signal', body });
}
