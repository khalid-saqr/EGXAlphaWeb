import { escapeHtml, htmlShell, prettyState, rel, signalCard } from './templates.mjs';
...
export function renderArchivePage(items) {
  ...
  return htmlShell({
    ...
    body: `<main class="site-shell">
      <header class="topbar"><a class="brand" href="${rel('/')}"><span class="brand-mark">EGX</span><span><strong>EGXResearch</strong><em>Archive</em></span></a><nav class="navlinks"><a href="${rel('/today/')}">Today</a><a href="${rel('/search/')}">Search</a></nav></header>
...
export function renderSearchPage() {
  return htmlShell({
    ...
    body: `<main class="site-shell">
      <header class="topbar"><a class="brand" href="${rel('/')}"><span class="brand-mark">EGX</span><span><strong>EGXResearch</strong><em>Search</em></span></a><nav class="navlinks"><a href="${rel('/today/')}">Today</a><a href="${rel('/archive/')}">Archive</a></nav></header>
